...
const months = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julio",
...
addBox.addEventListener("click", () => {
    ...
    addBtn.innerText = "Aicionar Nota";
                        ...
                        <div class="bottom-content">
                            ...
                            <div class="settings">
                                ...
                                <ul class="menu">
                                    ...
                                    <li onclick="deleteNote(${id})"><i class="uil uil-trash"></i>Apagar</li>
                                </ul>
                            </div>
                        </div>
                    </li>`;
...
function deleteNote(noteId) {
    let confirmDel = confirm("Tem certeza que deseja deletar esta nota?");
